    ...
    return(
        <aside>
            <div id = "info">
                ...
                <br />
                <p>You can expect anything from standard reviews to ruminations on different hobbies and talents. Additionally, there'll be the occasional article completely out of left field.</p>
            </div>
            <div id = "icon-box">
